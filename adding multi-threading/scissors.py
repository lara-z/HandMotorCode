...
start_ur5 = [1.7522521018981934, -2.645400663415426, -0.8602762222290039, -2.4010936222472132, 0.20627832412719727, 0.42722654342651367]
scissor_blade_length = float(0.03) # float(input('Enter the scissor blade length in the same coordinates as UR5 Cartesian coordinates:  ')) # !!!
