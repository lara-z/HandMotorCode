...
ROTATE_AMOUNT = deg2pulse(50) # the increment in degrees (converted to motor pulse units) you would like the motor to move
...
print('Press "w" to wind the motor(s), "u" to unwind the motor(s), or ESC to exit')
...
while 1:
    ...
    print_curr_volt(motor_id, portHandler, packetHandler, ADDR)
